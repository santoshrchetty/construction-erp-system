...
import { getPendingApprovals, approvePurchaseOrder, rejectPurchaseOrder, approveTimesheet, rejectTimesheet } from '@/app/actions/approvals/actions'
...
export default function ApprovalCenter() {
  ...
  const handleApprove = async (type: string, id: string) => {
    ...
    if (type === 'purchase-order') {
      ...
      result = await approveTimesheet(id, user.id)
    }
  ...
  const handleReject = async () => {
    ...
    if (showRejectModal.type === 'purchase-order') {
      result = await rejectPurchaseOrder(showRejectModal.id, user.id, rejectionReason)
    } else if (showRejectModal.type === 'timesheet') {
      result = await rejectTimesheet(showRejectModal.id, user.id, rejectionReason)
    }
