...
const CreateMaterialMaster = lazy(() => import('../features/materials/MaterialMasterComponents').then(module => ({ default: module.CreateMaterialMaster })))
const MaintainMaterialMaster = lazy(() => import('../features/materials/MaterialMasterComponents').then(module => ({ default: module.MaintainMaterialMaster })))
const DisplayMaterialMaster = lazy(() => import('../features/materials/MaterialMasterComponents').then(module => ({ default: module.DisplayMaterialMaster })))
const GoodsReceipt = lazy(() => import('../features/inventory/InventoryComponents').then(module => ({ default: module.GoodsReceipt })))
const GoodsIssue = lazy(() => import('../features/inventory/InventoryComponents').then(module => ({ default: module.GoodsIssue })))
const GoodsTransfer = lazy(() => import('../features/inventory/InventoryComponents').then(module => ({ default: module.GoodsTransfer })))
const PhysicalInventory = lazy(() => import('../features/inventory/InventoryComponents').then(module => ({ default: module.PhysicalInventory })))
const InventoryAdjustments = lazy(() => import('../features/inventory/InventoryComponents').then(module => ({ default: module.InventoryAdjustments })))
const GLPostingComponent = lazy(() => import('../features/finance/GLPosting'))
const TrialBalanceComponent = lazy(() => import('../features/finance/FinanceComponents').then(module => ({ default: module.TrialBalanceComponent })))
const ProfitLossComponent = lazy(() => import('../features/finance/FinanceComponents').then(module => ({ default: module.ProfitLossComponent })))
  ...
  const renderActiveComponent = () => {
    switch (activeComponent) {
      ...
      case 'Manage Projects':
        const { ManageProjectsComponent } = require('../features/projects/ManageProjectsComponent')
