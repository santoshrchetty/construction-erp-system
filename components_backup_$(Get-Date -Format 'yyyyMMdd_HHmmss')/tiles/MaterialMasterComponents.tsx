...
export function CreateMaterialMaster() {
  ...
  const materialTypes = [
    ...
    { code: 'HALB', name: 'Semi-Finished Product' },
  ...
  const searchMaterial = async (codeToSearch = null) => {
    ...
    try {
      ...
      if (data.success && data.data.material) {
        ...
        // Populate form data from retrieved material
        setFormData({
        ...
        // Load dependent dropdowns based on material data
        if (mat.category) {
  ...
  return (
    <div className="p-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {/* Search Section */}
        <div className="mb-6 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-md font-medium text-gray-900 mb-4">Search Materials</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
