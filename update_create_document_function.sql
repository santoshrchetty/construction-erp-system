-- Update create_document_with_lifecycle function to include discipline
CREATE OR REPLACE FUNCTION create_document_with_lifecycle(
  ...
  p_discipline VARCHAR DEFAULT 'CIVIL',
...
BEGIN
  ...
  INSERT INTO documents (
    ...
    document_subtype, part_number, parent_document_id, document_level, discipline, created_by
  ) VALUES (
    p_tenant_id, v_document_number, p_document_type, p_title, p_description,
    p_document_subtype, p_part_number, p_parent_document_id, v_document_level, p_discipline, p_created_by
