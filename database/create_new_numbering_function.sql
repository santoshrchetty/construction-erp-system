-- Create new RPC function with correct data types
...
BEGIN
  -- Lock the row to prevent concurrent access (cast fiscal_year to match column type)
  ...
  WHERE company_code = p_company_code
    ...
    AND fiscal_year = p_fiscal_year::varchar
