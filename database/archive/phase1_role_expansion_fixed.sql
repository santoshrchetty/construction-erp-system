-- Phase 1: Construction Industry Role Expansion (Fixed)
-- ====================================================

-- Create additional construction industry roles with shorter names
INSERT INTO roles (name, description, is_active) VALUES
('Site Engineer', 'Site engineering and quality oversight', true),
('Project Manager', 'Project management and coordination', true),
('Procurement Mgr', 'Materials procurement and vendors', true),
('Store Keeper', 'Warehouse and inventory management', true),
('Finance Manager', 'Financial control and budgets', true),
('Quality Manager', 'Quality assurance and compliance', true),
('Safety Officer', 'Health and safety compliance', true),
('Planning Engr', 'Project planning and scheduling', true)
...
-- Procurement Mgr: MM + FI + limited PS
INSERT INTO role_authorization_mapping (role_name, auth_object_name) VALUES
('Procurement Mgr', 'MM_PO_CREATE'),
('Procurement Mgr', 'MM_PO_APPROVE'),
('Procurement Mgr', 'MM_PO_MODIFY'),
('Procurement Mgr', 'MM_VEN_CREATE'),
('Procurement Mgr', 'MM_VEN_MODIFY'),
('Procurement Mgr', 'MM_MAT_CREATE'),
('Procurement Mgr', 'MM_MAT_MODIFY'),
('Procurement Mgr', 'FI_INV_PROCESS'),
('Procurement Mgr', 'FI_PAY_APPROVE'),
('Procurement Mgr', 'PS_PRJ_REVIEW'),
('Procurement Mgr', 'CO_BDG_VIEW')
ON CONFLICT (role_name, auth_object_name) DO NOTHING;
...
-- Planning Engr: PS + limited CO + DM
INSERT INTO role_authorization_mapping (role_name, auth_object_name) VALUES
('Planning Engr', 'PS_PRJ_REVIEW'),
('Planning Engr', 'PS_WBS_CREATE'),
('Planning Engr', 'PS_WBS_MODIFY'),
('Planning Engr', 'PS_ACT_SCHEDULE'),
('Planning Engr', 'PS_ACT_EXECUTE'),
('Planning Engr', 'PS_TSK_ASSIGN'),
('Planning Engr', 'PS_TSK_MANAGE'),
('Planning Engr', 'CO_BDG_VIEW'),
('Planning Engr', 'DM_DRAWING_VIEW')
ON CONFLICT (role_name, auth_object_name) DO NOTHING;
...
WHERE r.name IN ('Site Engineer', 'Project Manager', 'Procurement Mgr', 'Store Keeper', 'Finance Manager', 'Quality Manager', 'Safety Officer', 'Planning Engr')
GROUP BY r.name
ORDER BY r.name;