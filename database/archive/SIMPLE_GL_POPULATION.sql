-- Simple GL Posting Data Population
-- Works with existing table structures

-- Insert Cost Centers (this should work)
...
-- Insert WBS Elements (basic project data)
INSERT INTO wbs_elements (company_code, project_code, wbs_element, wbs_description, wbs_level, project_manager, is_active) VALUES
('C001', 'PROJ-001', 'PROJ-001', 'Office Building Construction', 1, 'Project Manager A', true),
('C001', 'PROJ-002', 'PROJ-002', 'Highway Bridge Project', 1, 'Project Manager B', true),
('B001', 'PROJ-003', 'PROJ-003', 'Infrastructure Development', 1, 'Project Manager US', true)
...
SELECT 'GL posting data populated successfully' as status;