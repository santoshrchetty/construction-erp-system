...
-- Create stock balances for C002 materials in P002 storage locations (0001 and 0003)
...
CROSS JOIN (
  ...
  WHERE p.plant_code = 'P002' AND sl.sloc_code IN ('0001', '0003')
  LIMIT 1
) sl
WHERE si.item_code LIKE 'INFRA-%';