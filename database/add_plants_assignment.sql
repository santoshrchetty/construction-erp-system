...
-- Add storage locations for the plants
INSERT INTO storage_locations (storage_location_code, storage_location_name, plant_id, storage_type) VALUES
...
ON CONFLICT (plant_id, storage_location_code) DO NOTHING;
