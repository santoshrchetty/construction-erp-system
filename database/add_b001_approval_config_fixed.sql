...
-- Specific setup for B001 organizational structure with proper UUIDs
...
SELECT * FROM get_approval_path(
  'b001c0de-e29b-41d4-a716-446655440001'::UUID,
  'MATERIAL_REQ',
  3500
);
...
-- 6. B001 specific validation and metrics
...
WHERE customer_id = 'b001c0de-e29b-41d4-a716-446655440001'
AND is_active = true
