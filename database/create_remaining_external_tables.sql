-- =====================================================
-- EXTERNAL ACCESS - REMAINING TABLES
-- =====================================================

-- 1. EXTERNAL_ORG_USERS
CREATE TABLE IF NOT EXISTS public.external_org_users (
...
CREATE INDEX IF NOT EXISTS idx_ext_org_users_org ON external_org_users(external_org_id);
CREATE INDEX IF NOT EXISTS idx_ext_org_users_user ON external_org_users(user_id);
...
CREATE INDEX IF NOT EXISTS idx_ext_org_rel_parent ON external_org_relationships(parent_org_id);
CREATE INDEX IF NOT EXISTS idx_ext_org_rel_child ON external_org_relationships(child_org_id);
...
CREATE INDEX IF NOT EXISTS idx_resource_access_org ON resource_access(external_org_id);
CREATE INDEX IF NOT EXISTS idx_resource_access_type ON resource_access(resource_type);
...
CREATE TABLE IF NOT EXISTS public.drawing_customer_approvals (
...
CREATE INDEX IF NOT EXISTS idx_drawing_approvals_org ON drawing_customer_approvals(external_org_id);
...
CREATE TABLE IF NOT EXISTS public.vendor_progress_updates (
...
CREATE INDEX IF NOT EXISTS idx_vendor_progress_drawing ON vendor_progress_updates(drawing_id);
CREATE INDEX IF NOT EXISTS idx_vendor_progress_org ON vendor_progress_updates(external_org_id);
...
-- 6. DRAWING_RACI
CREATE TABLE IF NOT EXISTS public.drawing_raci (
...
CREATE INDEX IF NOT EXISTS idx_drawing_raci_org ON drawing_raci(external_org_id);
...
CREATE TABLE IF NOT EXISTS public.external_access_audit_log (
...
CREATE INDEX IF NOT EXISTS idx_audit_log_user ON external_access_audit_log(user_id);
CREATE INDEX IF NOT EXISTS idx_audit_log_action ON external_access_audit_log(action_type);
CREATE INDEX IF NOT EXISTS idx_audit_log_performed ON external_access_audit_log(performed_at);
