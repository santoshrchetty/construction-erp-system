...
BEGIN
  ...
  RAISE NOTICE '% DG auth objects created for OMEGA-DEV', (SELECT COUNT(*) FROM authorization_objects WHERE module = 'DG' AND tenant_id = '9bd339ec-9877-4d9f-b3dc-3e60048c1b15');
END $$;

-- Verify
SELECT COUNT(*) as dg_auth_objects_count
