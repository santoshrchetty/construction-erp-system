-- Add company_code string column to projects table
-- Keep existing company_code_id for referential integrity

ALTER TABLE projects ADD COLUMN IF NOT EXISTS company_code VARCHAR(10);

-- Populate company_code from company_code_id lookup
UPDATE projects 
