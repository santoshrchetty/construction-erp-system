-- Set sequence_order for all tiles based on functional flow
...
UPDATE tiles SET sequence_order = 3 WHERE title = 'WBS Management';
UPDATE tiles SET sequence_order = 4 WHERE title = 'Activities';
UPDATE tiles SET sequence_order = 5 WHERE title = 'Tasks';
UPDATE tiles SET sequence_order = 6 WHERE title = 'Schedule';
UPDATE tiles SET sequence_order = 7 WHERE title = 'Resource Planning';
UPDATE tiles SET sequence_order = 8 WHERE title = 'Cost Management';
